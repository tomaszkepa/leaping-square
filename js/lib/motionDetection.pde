...
final int motionChangeThreshold = 200;      // again arbitary, the amount of pixels that need to change for there to be regarded as motion
...
void draw() {
    ...
    if (currentImage != null && previousImage != null) {
        ...
        //ellipseMode(CENTER);
        //ellipse(motionDetectionPoint.x,  motionDetectionPoint.y, 60, 60);
        //fill(0);
